...
with open("VGG_Ascend_SSD_300x300.log", "r") as f:
    raw_data = f.read()
...
acc_iterations[-1]= iterations[-1]
#acc_over_time.append(acc_over_time[-1])

#acc_iterations = acc_iterations[:40]
#acc_over_time = acc_over_time[:40]

#iterations = iterations[:2000]
#loss_over_time = loss_over_time[:2000]
print max(iterations)
print len(loss_over_time)
print iterations[-1]
print loss_over_time[-1]
print acc_iterations
print acc_over_time
print max(acc_iterations)
...
yhat = savitzky_golay(np.array(loss_over_time), 71, 3) # window size 71, polynomial order 3
ax1.plot(iterations, yhat, color="red")


plt.savefig("VGG_Ascend_SSD_300x300.png", dpi=150)
