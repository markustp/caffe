...
with open("YOLOv2_log.txt", "r") as f:
    raw_data = f.read()
...
yhat = savitzky_golay(np.array(loss_over_time), 701, 3) # window size 71, polynomial order 3
ax1.plot(iterations, yhat, color="red")


plt.savefig("YOLOv2.png", dpi=150)
